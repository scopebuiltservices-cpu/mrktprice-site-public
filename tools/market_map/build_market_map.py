...
# SEC EDGAR insider (Form 4) + fiscal-map helpers extracted to sec_insider.py (file-budget).
from sec_insider import fetch_insider, _sec_fiscal_map, _INS_UA  # noqa: F401
